...
| Post-traitement (distant, texte uniquement) | `gpt-5.6-sol` via l’interface en ligne de commande `codex` | gérée par le service | s.o. |
...
| `Tests/` | 147 tests fondés sur des fixtures, répartis en 16 suites |
